...
echo "======================================================================================"
echo ""
echo "Digital Ocean basics applied, please upgrade your Kernel in the DO control panel"
echo ""
echo "We installed the following during the update;"
echo ""
rpm -q --queryformat "%{installtime} %{version}-%{release}.%{arch}\n" kernel | sort -nr | sed -n 1p | cut -d' ' -f2
echo ""
echo "But you have the following enabled;"
echo ""
uname -r
echo ""
echo "======================================================================================"
